...
1. **Prepare mold** by cleaning the mold thoroughly and applying a thin coat of release agent and letting it dry.
    1. ☆ **Prepare cores** this can be either 3D printing our [cores](/negshell-cores) or similar cores
    1. or go through a process as long as the upcoming steps just to cast the cores in wax.
